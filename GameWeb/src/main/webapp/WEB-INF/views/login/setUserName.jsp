                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                        	<div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4"> 마지막 단계입니다! </h1>
                            </div>
                            <div class="text-center">
                                <h3 class="h6 text-gray-900 mb-4"> 닉네임을 정해주세요 </h3>
                            </div>
                            
                            <form action="/login/setUserName.do" method="post" class="user">
                            	<input type="hidden" id="user_id" name="user_id" value="${email}">
                            	<input type="hidden" id="naver_login" name="naver_login" value="${naverLogin}">
